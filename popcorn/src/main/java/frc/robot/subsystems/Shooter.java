...
public class Shooter extends SubsystemBase {
  ...
  public Shooter() {
    ...
    // SmartDashboard.putNumber("acceleratorDesiredSetpoint", 5000);
    ...
    // SmartDashboard.putNumber("flywheelDesiredSetpoint", 13000);
    // SmartDashboard.putNumber("flywheelSetP", 0.35);
    // SmartDashboard.putNumber("flywheelSetI", 0);
    // SmartDashboard.putNumber("flywheelSetD", 14.5);
    // SmartDashboard.putNumber("flywheelSetF", 0.046);

    updateConstants();
  }

  public void update() {
    // SmartDashboard.putNumber("graph/acceleratorVelocity", acceleratorEncoder.getVelocity());
    // SmartDashboard.putNumber("graph/flywheelLeaderVelocity", flywheelLeaderTalonFX.getSelectedSensorVelocity()); 

    updateConstants();
  }

  public void set(double acceleratorSetpoint, double flywheelSetpoint) {
    // acceleratorSetpoint = SmartDashboard.getNumber("acceleratorDesiredSetpoint", 5000);
    ...
    // flywheelSetpoint = SmartDashboard.getNumber("flywheelDesiredSetpoint", 13000);
  ...
  public void testSet(double acceleratorSetpoint, double flywheelSetpoint) {
    // acceleratorSetpoint = SmartDashboard.getNumber("acceleratorDesiredSetpoint", 1000);
    acceleratorController.setReference(acceleratorSetpoint, ControlType.kVelocity);
    // SmartDashboard.putNumber("acceleratorSetpoint", acceleratorSetpoint);

    flywheelLeaderTalonFX.set(ControlMode.PercentOutput, 0.7);
  ...
  // public double flywheelP = 0.35;
  // public double flywheelI = 0;
  // public double flywheelD = 14.5;
  // public double flywheelF = 0.046;
  ...
  public void updateConstants() {
    ...
    // flywheelP = SmartDashboard.getNumber("flywheelSetP", 0.35);
    // flywheelI = SmartDashboard.getNumber("flywheelSetI", 0);
    // flywheelD = SmartDashboard.getNumber("flywheelSetD", 14.5);
    // flywheelF = SmartDashboard.getNumber("flywheelSetF", 0.046);
